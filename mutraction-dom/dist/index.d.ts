...
export declare class PropReference<T = any> {
	...
	notifySubscribers(changeInfo?: PropRefChangeInfo): void;
	get current(): T;
...
declare const RecordSplice: unique symbol;
...
export declare class Tracker {
	 ...
	 */
	[RecordSplice](target: Array<unknown>, start: number, deleteCount: number, insert: any[]): void;
	/** record a mutation, if you have the secret key  */
	[RecordMutation](target: object, name: Key): void;
...
declare class DependencyList {
	...
	notifySubscribers(trigger?: PropReference, info?: PropRefChangeInfo): void;
